	...
	function saveCriteria(){
		...
		for (var i = 0; i < numElements; i++){
			...
			if ($("#" + criteriaTypeField).length > 0){
				...
				criteriaJSON.push({num: num, criteriaType : criteriaType, booleanValue : booleanValue, criteriaVal : criteriaValue})
				num = num + 1
			}
		}
		...
		var myval = JSON.stringify(criteriaJSON); // generated by PHP
		console.log(myval)
		...
		$.ajax({
		  type: 'POST',
		  url: 'saveToDB.php',
		  data: {'json': myval, 'playlistName': playlistName},
		});
